...
import { debounceEvent, clamp, renderHiddenInput } from '../../utils/helpers';
import { hostContext, setClassList } from '../../utils/style';
import { KnobName, RangeValue, RangeChangeEventDetail } from './range.interface';
...
export class Range implements ComponentInterface {
  ...
  @Element() el!: HTMLBkkrRangeElement;
   ...
   */
  @Event() bkkrChange!: EventEmitter<RangeChangeEventDetail>;
  ...
  connectedCallback() {
     ...
     * bkkr-range, then rangeSlider is not defined.
     * But if we are moving bkkr-range via appendChild,
