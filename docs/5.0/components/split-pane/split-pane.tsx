import { Component, ComponentInterface, Host, h, Prop, Build, EventEmitter, State, Watch, Event, Element } from '@stencil/core';
...
export class SplitPane implements ComponentInterface {
   ...
   */
  @Event() bkkrSplitPaneVisible!: EventEmitter<{visible: boolean}>;

  @Watch('visible')
  visibleChanged(visible: boolean) {
    const detail = { visible, isPane: this.isPane.bind(this) };
    this.bkkrSplitPaneVisible.emit(detail);
  }
